...
class UserInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post user_infos_url, params: { user_info: { address: @user_info.address, mobile: @user_info.mobile, name: @user_info.name, postal_code: @user_info.postal_code, pref_id: @user_info.pref_id, user_id: @user_info.user_id } }
    end
  ...
  test "should update user_info" do
    patch user_info_url(@user_info), params: { user_info: { address: @user_info.address, mobile: @user_info.mobile, name: @user_info.name, postal_code: @user_info.postal_code, pref_id: @user_info.pref_id, user_id: @user_info.user_id } }
